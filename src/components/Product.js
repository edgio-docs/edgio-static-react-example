      ...
      <div className="flex w-full flex-col items-start md:flex-row">
        <div className="relative flex w-full flex-col items-start md:w-[65%]">
          <div className="absolute top-0 left-0 z-50 flex flex-col items-start">
            <h3 className="bg-white py-2 px-4 text-2xl font-bold text-black">{loading ? '' : data.name}</h3>
            <h4 className="bg-white py-2 px-4 text-lg text-black">{`$ ${loading ? '' : data.prices.price.value} ${
              loading ? '' : data.prices.price.currencyCode
            }`}</h4>
          </div>
          ...
          <div className="relative flex w-full flex-col items-center">
            ...
            {loading && <div className="bg-white/50 animate-pulse h-auto w-[600px] object-contain"></div>}
          </div>
          {!loading && (
        ...
        <div className="flex w-full flex-col items-start px-10 md:w-[35%]">
          <h1 className="mt-10 text-3xl font-bold text-white md:mt-0">{loading ? '' : data.name}</h1>
